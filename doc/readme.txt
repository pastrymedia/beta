...
---------------------
Beta is a parent theme for WordPress and Beta child
...
Install
-------
1. Upload the beta folder via FTP to your wp-content/themes/ directory.
2. Go to your WordPress dashboard and select Appearance.
3. Be sure to activate the Beta child theme, and not the Beta parent theme.
...
0.3.0	2013-08-03
- add sample beta child theme
- cleaned up files and functions
- add schema.org markup
- Introduced beta actions
