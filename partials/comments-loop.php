<?php if ( have_comments() ) : ?>
	<h3><?php comments_number( '', __( 'One Response', 'beta' ), __( '% Responses', 'beta' ) ); ?></h3>
	...
	<ol class="comment-list">
		<?php
			 ...
			 * to use beta_comment() to format the comments.
			 * If you want to overload this in a child theme then you can
			 * define beta_comment() and that will be used instead.
			 * See beta_comment() in lib/inc/template-tags.php for more.
			 */
			$args = array(
				'walker'            => null,
				'max_depth'         => '',
				'style'             => 'ul',
				'callback'          => 'beta_comment',
				'end-callback'      => null,
				'type'              => 'all',
				'reply_text'        => 'Reply',
				'page'              => '',
